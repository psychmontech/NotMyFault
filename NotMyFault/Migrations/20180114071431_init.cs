    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CrypCurAddrId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CrypCurAddr", x => x.CrypCurAddrId);
                    table.ForeignKey(
                        name: "FK_CrypCurAddr_AspNetUsers_DeveloperForeignKey",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CrypCurAddr_DeveloperForeignKey",
                table: "CrypCurAddr",
