    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CryptcurAddrId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    BitcoinAddr = table.Column<string>(nullable: true),
                    EthereumAddr = table.Column<string>(nullable: true),
                    LitecoinAddr = table.Column<string>(nullable: true),
                    UserForeignKey = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CryptcurAddrs", x => x.CryptcurAddrId);
                    table.ForeignKey(
                        name: "FK_CryptcurAddrs_AspNetUsers_UserForeignKey",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CryptcurValueId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    AcceptBitcoid = table.Column<bool>(nullable: false),
                    AcceptEthereum = table.Column<bool>(nullable: false),
                    AcceptLitecoin = table.Column<bool>(nullable: false),
                    BitcoinValue = table.Column<double>(nullable: false),
                    EthereumValue = table.Column<double>(nullable: false),
                    LitecoinValue = table.Column<double>(nullable: false),
                    ProjectForeignKey = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CryptcurValues", x => x.CryptcurValueId);
                    table.ForeignKey(
                        name: "FK_CryptcurValues_Projects_ProjectForeignKey",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Offers_Projects_ProjectForeignKey",
                        column: x => x.ProjectForeignKey,
                        principalTable: "Projects",
                        principalColumn: "ProjectId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProjectForeignKey = table.Column<int>(nullable: false),
                    TranAmount = table.Column<decimal>(nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CryptcurAddrs_UserForeignKey",
                table: "CryptcurAddrs",
                column: "UserForeignKey",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_CryptcurValues_ProjectForeignKey",
                table: "CryptcurValues",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Offers_ProjectForeignKey",
                table: "Offers",
                column: "ProjectForeignKey");
